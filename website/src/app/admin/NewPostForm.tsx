...
export default function NewPostForm() {
  ...
  return (
    <form
      ...
      className="space-y-6 border p-6 rounded shadow-sm bg-gray-50"
    >
      ...
      <div>
        ...
        <p className="text-sm text-gray-500">
          It will be inserted into the content automatically.
        </p>
      </div>
      ...
      <div>
        <h3 className="text-lg font-semibold mt-4 text-black mb-2">Live Preview</h3>
