    ...
    <div className="container mx-auto py-8">
      <div className="flex justify-around items-center mb-4">
        <h1 className="text-3xl font-bold">
          Find us with a <span className="text-blue-500">/click</span>
        </h1>
      </div>
      <div className="flex flex-wrap justify-center">
        {sections.map((section) => (
          <button
            ...
            className="px-4 py-2 m-2 bg-blue-500 text-white rounded hover:bg-blue-600 transition"
          >
            {section.name}
          </button>
        ))}
...
function TeamSection({ id, preEmphasis, emphasis, postEmphasis, members }) {
  return (
    <section id={id} className="container mx-auto py-12" data-aos="fade-up">
      <div className="text-center mb-8">
        <h1 className="text-2xl font-bold">
          {preEmphasis}
          <span className="text-blue-500">{emphasis}</span>
          {postEmphasis}
        </h1>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">{members}</div>
    </section>
  );
}
